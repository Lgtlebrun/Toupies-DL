...
#include <memory>
#include "../../ScientificToupieSimulator/headers/TextEdit.h"
...
QT_MOC_LITERAL(1, 9, 10), // "restartStp"
QT_MOC_LITERAL(2, 20, 0) // ""

    },
    "TextEdit\0restartStp\0"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TextEdit::restartStp)) {
                *result = 0;
                return;
            }
        }
