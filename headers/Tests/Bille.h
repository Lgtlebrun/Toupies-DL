...
// =========
    ...
    Bille(SupportADessin&, double, double, double, double);         // ctor de Bille prenant comme argument le support à
...
// =========
    ...
    virtual Vecteur equEvol(double const& temps) const;             // equation du mouvement d'une bille lâchée ou lancée
