...
// =========
    ...
    Integrateur(double const& t0)
        : m_t(t0)
    {}
/*ctor de l'intégrateur, caractérisé seulement par le temps. En fait, il est approximateur de l'équation différentielle E(t,x(t),x'(t)) *
 * = x''(t). Donc on le pose à t=t0 et il nous dit comment faire évoluer les paramètres                                                 */
